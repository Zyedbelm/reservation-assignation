-- Update the direct Make.com cron job to call auto-sync-scheduler edge function instead
SELECT cron.alter_job(
  ...
  SELECT
    net.http_post(
        ...
        body:=('{"source": "auto_cron_scheduler", "trigger": "auto_scheduler", "timestamp": "' || now() || '", "clean_duplicates": true}')::jsonb
    ) as request_id;
  $$
);