...
-- Créer les fonctions RPC pour gérer les notifications GM
...
-- Fonction pour marquer toutes les notifications d'un GM comme lues
...
-- Fonction pour mettre à jour le statut d'envoi d'email
